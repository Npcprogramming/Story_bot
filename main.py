...
CREATOR_ID = 334124671   # Замените на ваш Telegram ID
    ...
    story = {
        ...
        35: {
            "text": (
                ...
                "Но в этом нет смысла без читателей. Если увижу, что людей заинтересовало, то начну выпускать продолжение прямо тут.\n\n"               
...
def main():
    token = "8145921234:AAFboQKLDoawrYhMHciPh8t6eFJ_sYkoLog"  # Замените на реальный токен вашего бота
